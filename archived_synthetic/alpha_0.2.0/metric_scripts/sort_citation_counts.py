...
INPUT_PATH = "archived_synthetic/alpha_0.2.0/output/citation_counts/citation_counts.jsonl"
OUTPUT_PATH = "archived_synthetic/alpha_0.2.0/output/citation_counts/citation_counts_ordered.jsonl"
