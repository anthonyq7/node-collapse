...
for node in range(MAX_NODES):
    ...
    stats_path = f"archived_synthetic/alpha_0.2.0/output/node_{node}/node_{node}_stats.jsonl"
    ...
    node_path = f"archived_synthetic/alpha_0.2.0/output/node_{node}/node_{node}.jsonl"
    ...
    output_path = f"archived_synthetic/alpha_0.2.0/output/node_{node}/node_{node}_exposure.jsonl"
