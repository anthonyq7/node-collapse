...
def load_node_stats(node: int) -> dict:
    ...
    stats = {}
    path = f"archived_synthetic/prototype/output/node_{node}/node_{node}_stats.jsonl"
...
def main():
    ...
    #save to JSONL
    with open("archived_synthetic/prototype/output/master/generation_stats.jsonl", "w") as f:
        for result in results:
            f.write(json.dumps(result) + "\n")
    
    print(f"\n{'='*40}")
    print("Saved to prototype/output/master/generation_stats.jsonl")
