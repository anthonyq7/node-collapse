...
def load_node_stats(node: int) -> dict:
    stats = {}
    path = f"archived_synthetic/alpha/output/node_{node}/node_{node}_stats.jsonl"
...
def main():
    ...
    with open("archived_synthetic/alpha/output/master/generation_stats.jsonl", "w") as f:
